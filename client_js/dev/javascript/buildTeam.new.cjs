...
const teamsData = JSON.parse(fs.readFileSync('../../../class_data/ProjectTeams.json'));
const membersData = JSON.parse(fs.readFileSync('../../../class_data/ProjectMembers.json'));
...
//                        console.log(`Adding ${github} to ${dbName}`);
                        console.log(`gh api -X PUT /repos/uvucs3660/${dbName}/collaborators/${github} --field permission=push`);
